// VendorProfileWarningBanner.jsx
import { Link } from 'react-router-dom';
import { useState } from 'react';

export const VendorProfileWarningBanner = ({ profileCompleted }) => {
  const [isDismissed, setIsDismissed] = useState(false);
  
  if (profileCompleted || isDismissed) return null;
      ...
      <div className="flex items-start">
        ...
        <div className="ml-3 flex-1">
          ...
          <p className="text-sm text-yellow-700 mt-1">
            Please complete your vendor profile before uploading products. This ensures smooth order processing and delivery.
          </p>
          <div className="mt-3">
            <Link 
              to="/vendor/profile"
